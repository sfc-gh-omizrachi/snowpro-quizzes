...
## Q34 (Single Answer)
Which Snowflake feature lets an administrator detect and act on users whose passwords appear in known breach databases?
- A) Trust Center Scanner for leaked credentials
- B) Snowflake Trail anomaly detection
- C) PASSWORD_POLICY with BREACH_CHECK = TRUE
- D) ACCOUNT_USAGE.COMPROMISED_CREDENTIALS view
